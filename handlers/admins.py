...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("CheemsBot=▶️ Paused.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("CheemsBot=⏸ Resumed.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("CheemsBot=⏹ Stopped streaming.")
...
async def skip(client: Client, message: Message):
    ...
    await message.reply_text("CheemsBot=⏩ Skipped the current song.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("CheemsBot=❇️ Admin cache refreshed!")
