...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("GamerzBot=▶️ Paused.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("GamerzBot=⏸ Resumed.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("GamerzBot=⏹ Stopped streaming.")
...
async def skip(client: Client, message: Message):
    ...
    await message.reply_text("GamerzBot=⏩ Skipped the current song.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("GamerzBot=❇️ Admin cache refreshed!")
