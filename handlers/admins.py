...
async def pause(client: Client, message: Message):
    ...
    await message.reply_text("✯sтαя_вσт✯=▶️ Paused.")
...
async def resume(client: Client, message: Message):
    ...
    await message.reply_text("✯sтαя_вσт✯=⏸ Resumed.")
...
async def stop(client: Client, message: Message):
    ...
    await message.reply_text("✯sтαя_вσт✯=⏹ Stopped streaming.")
...
async def skip(client: Client, message: Message):
    ...
    await message.reply_text("✯sтαя_вσт✯=⏩ Skipped the current song.")
...
async def admincache(client, message: Message):
    ...
    await message.reply_text("✯sтαя_вσт✯=❇️ Admin cache refreshed!")
